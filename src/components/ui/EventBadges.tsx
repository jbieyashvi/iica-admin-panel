...
export const ArchiveStatusBadge = ({ status }: { status: ArchiveStatus }) => <Badge tone={ARCHIVE_STATUS_TONE[status]}>{ARCHIVE_STATUS_LABEL[status]}</Badge>;
export const YtStatusBadge = ({ status }: { status: YouTubeStatus }) => <Badge tone={YT_STATUS_TONE[status]}>{YT_STATUS_LABEL[status]}</Badge>;
